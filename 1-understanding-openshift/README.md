...
4. Select "Image Name" and enter `openshiftkatacoda/blog-django-py` as name, click on the "magnifying glass". 
...
7. In the project overview, click on the twistie (1) to open the overview of the application. This example should be familiar, it was used in the second tutorial on the Read Hat Learning portal.
...
10. Display all object that belong to your project:
...
11. Display all objects that are labelled with your app name, it should be the same as before:
...
Check the IBM Cloud Solution Tutorial [Scalable web application on OpenShift](https://cloud.ibm.com/docs/tutorials?topic=solution-tutorials-scalable-webapp-openshift).
